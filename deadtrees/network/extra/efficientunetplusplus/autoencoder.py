...
from .autoencoder_decoder import EfficientUnetPlusPlusAEDecoder


class EfficientUnetPlusPlusAutoencoder(SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder = EfficientUnetPlusPlusAEDecoder(
        ...
        # let's try to simply use in_channels as the out_channel setting
        self.segmentation_head = SegmentationHead(
            in_channels=decoder_channels[-1],
