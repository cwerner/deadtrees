# source: https://github.com/LucasFidon/GeneralizedWassersteinDiceLoss
#
# proposed in:
# Fidon, L. et al. (2018). Generalised Wasserstein Dice Score for Imbalanced Multi-class
#  Segmentation Using Holistic Convolutional Networks. In: Crimi, A., Bakas, S., Kuijf, H.,
#  Menze, B., Reyes, M. (eds) Brainlesion: Glioma, Multiple Sclerosis, Stroke and Traumatic
#  Brain Injuries. BrainLes 2017. Lecture Notes in Computer Science(), vol 10670. Springer,
#  Cham. https://doi.org/10.1007/978-3-319-75238-9_6
...
class GeneralizedWassersteinDiceLoss(_Loss):
    ...
    def compute_alpha_generalized_true_positives(self, flat_target):
        ...
        if self.alpha_mode == "GDL":  # GDL style
            ...
            one_hot = (
                F.one_hot(flat_target, num_classes=self.num_classes)  # shape: b,c,s
                .permute(0, 2, 1)
                .float()
            )
